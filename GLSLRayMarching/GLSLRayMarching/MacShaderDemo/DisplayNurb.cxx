...
void DisplayNurb(FbxNode* pNode)
{
    ...
    Debug("    Nurb U Type: ", lNurbTypes[lNurbs->GetNurbsUType()]);
    DisplayInt("    U Count: ", lNurbs->GetUCount());
    Debug("    Nurb V Type: ", lNurbTypes[lNurbs->GetNurbsVType()]);
