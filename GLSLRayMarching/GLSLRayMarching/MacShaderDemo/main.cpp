...
Scene::Creator<PhysicsDemoScene> PhysicsDemoSceneCreator("PhysicsDemo");
Scene::Creator<MeshProcessingScene> MeshProcessingSceneCreator("MeshProcessing");
