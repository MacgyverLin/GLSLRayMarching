		...
		for (j = 0; j < lPolygonSize; j++)
		{
			...
			for (l = 0; l < pMesh->GetElementVertexColorCount(); l++)
			{
				...
				case FbxGeometryElement::eByControlPoint:
					...
					case FbxGeometryElement::eDirect:
						DisplayColor("            Color vertex: ", leVtxc->GetDirectArray().GetAt(lControlPointIndex));
						break;
			...
			for (l = 0; l < pMesh->GetElementUVCount(); ++l)
			{
				...
				case FbxGeometryElement::eByControlPoint:
					...
					{
					case FbxGeometryElement::eDirect:
						Display2DVector("            Texture UV: ", leUV->GetDirectArray().GetAt(lControlPointIndex));
						break;
					case FbxGeometryElement::eIndexToDirect:
						{
				...
				case FbxGeometryElement::eByPolygonVertex:
					{
						...
						case FbxGeometryElement::eIndexToDirect:
							{
								Display2DVector("            Texture UV: ", leUV->GetDirectArray().GetAt(lTextureUVIndex));
							}
							break;
						default:
							break; // other reference modes not shown here!
			...
			for( l = 0; l < pMesh->GetElementNormalCount(); ++l)
			{
				...
				if(leNormal->GetMappingMode() == FbxGeometryElement::eByPolygonVertex)
				{
					...
					{
					case FbxGeometryElement::eDirect:
						Display3DVector("            Normal: ", leNormal->GetDirectArray().GetAt(vertexId));
						break;
					case FbxGeometryElement::eIndexToDirect:
						{
			...
			for( l = 0; l < pMesh->GetElementTangentCount(); ++l)
			{
				...
				if(leTangent->GetMappingMode() == FbxGeometryElement::eByPolygonVertex)
				{
					...
					{
					case FbxGeometryElement::eDirect:
						Display3DVector("            Tangent: ", leTangent->GetDirectArray().GetAt(vertexId));
						break;
					case FbxGeometryElement::eIndexToDirect:
						{
			...
			for( l = 0; l < pMesh->GetElementBinormalCount(); ++l)
			{
				...
				if(leBinormal->GetMappingMode() == FbxGeometryElement::eByPolygonVertex)
				{
					...
					{
					case FbxGeometryElement::eDirect:
						Display3DVector("            Binormal: ", leBinormal->GetDirectArray().GetAt(vertexId));
						break;
					case FbxGeometryElement::eIndexToDirect:
						{
