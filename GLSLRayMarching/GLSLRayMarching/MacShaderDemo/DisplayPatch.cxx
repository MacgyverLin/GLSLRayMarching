...
void DisplayPatch(FbxNode* pNode)
{
    ...
    Debug("    Patch U Type: ", lPatchTypes[lPatch->GetPatchUType()]);
    DisplayInt("    U Count: ", lPatch->GetUCount());
    Debug("    Patch V Type: ", lPatchTypes[lPatch->GetPatchVType()]);
