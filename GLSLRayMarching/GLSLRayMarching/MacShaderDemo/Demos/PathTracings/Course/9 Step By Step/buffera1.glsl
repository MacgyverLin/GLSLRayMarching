...
const Material materials[NUM_MATERIALS] =
{
    ...
    Material(DIFF  ,  0, vec3(1.00, 1.00, 1.00), -1, vec3(0.00, 0.00, 0.00), 0.0,  0),
    Material(SPEC  ,  2, vec3(0.00, 0.70, 0.70), -1, vec3(0.00, 0.00, 0.00), 1.5,  2),
    Material(GLOSSY,  1, vec3(0.75, 1.00, 0.75), -1, vec3(0.00, 0.00, 0.00), 1.5,  1),
