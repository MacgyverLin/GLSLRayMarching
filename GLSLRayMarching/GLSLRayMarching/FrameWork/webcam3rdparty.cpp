...
void videoInput::getMediaSubtypeAsString(GUID type, char * typeAsString){
	...
	char tmpStr[maxStr];
	if( type == MEDIASUBTYPE_RGB24) strncpy_s(tmpStr, sizeof("RGB24"), "RGB24", maxStr);
	else if(type == MEDIASUBTYPE_RGB32) strncpy_s(tmpStr, sizeof("RGB32"), "RGB32", maxStr);
	else if(type == MEDIASUBTYPE_RGB555)strncpy_s(tmpStr, sizeof("RGB555"), "RGB555", maxStr);
	else if(type == MEDIASUBTYPE_RGB565)strncpy_s(tmpStr, sizeof("RGB565"), "RGB565", maxStr);
	else if(type == MEDIASUBTYPE_YUY2) strncpy_s(tmpStr, sizeof("YUY2"), "YUY2", maxStr);
	else if(type == MEDIASUBTYPE_YVYU) strncpy_s(tmpStr, sizeof("YVYU"), "YVYU", maxStr);
	else if(type == MEDIASUBTYPE_YUYV) strncpy_s(tmpStr, sizeof("YUYV"), "YUYV", maxStr);
	else if(type == MEDIASUBTYPE_IYUV) strncpy_s(tmpStr, sizeof("IYUV"), "IYUV", maxStr);
	else if(type == MEDIASUBTYPE_UYVY) strncpy_s(tmpStr, sizeof("UYVY"), "UYVY", maxStr);
	else if(type == MEDIASUBTYPE_YV12) strncpy_s(tmpStr, sizeof("YV12"), "YV12", maxStr);
	else if(type == MEDIASUBTYPE_YVU9) strncpy_s(tmpStr, sizeof("YVU9"), "YVU9", maxStr);
	else if(type == MEDIASUBTYPE_Y411) strncpy_s(tmpStr, sizeof("Y411"), "Y411", maxStr);
	else if(type == MEDIASUBTYPE_Y41P) strncpy_s(tmpStr, sizeof("Y41P"), "Y41P", maxStr);
	else if(type == MEDIASUBTYPE_Y211) strncpy_s(tmpStr, sizeof("Y211"), "Y211", maxStr);
	else if(type == MEDIASUBTYPE_AYUV) strncpy_s(tmpStr, sizeof("AYUV"), "AYUV", maxStr);
	else if(type == MEDIASUBTYPE_Y800) strncpy_s(tmpStr, sizeof("Y800"), "Y800", maxStr);
	else if(type == MEDIASUBTYPE_Y8) strncpy_s(tmpStr, sizeof("Y8"), "Y8", maxStr);
	else if(type == MEDIASUBTYPE_GREY) strncpy_s(tmpStr, sizeof("GREY"), "GREY", maxStr);
	else strncpy_s(tmpStr, sizeof("OTHER"), "OTHER", maxStr);
